...
- Prefer compressing at the start of a new task, as only then will you know which sections aren't needed for said new task
- Avoid compressing at the end of a task, as the user might request a immediate follow up on those freshly finished tasks
...
- If you've just finished your tasks, as the user might request an immediate follow up
