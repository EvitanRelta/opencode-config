...
Do not call any tools. This is a retrospective to collect learning points for updating AGENTS.md.
...
1. **Learning point** — what you learned about my preference.
2. **Existing instruction** — the relevant current wording, or `None`.
3. **Gap** — one concise sentence explaining what is missing or ineffective.
4. **Recommended text** — a concise, paste-ready addition or replacement using authoritative AGENTS.md wording such as `DO NOT`.
